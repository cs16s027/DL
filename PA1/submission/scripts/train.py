...
if args.pretrain == "false":
    ...
    print 'Please run the code again with the pretrained model path as the value of this parameter'
    sys.exit(1)
else:
...
with open(os.path.join(model_path, results_file), 'wb') as f:
    ...
    for index, p in enumerate(predictions):
        f.write('{},{}\n'.format(index, p))
print 'The final model can be found at:', os.path.join(model_path, model_name)
print 'The prediction on test data can be found at:', os.path.join(model_path, results_file)
