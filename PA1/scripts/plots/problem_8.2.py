...
def plot(points, plot_name, plot_title):
    ...
    ax.plot(points['1'][0], points['adam'][1], linewidth = 1, color = 'red')
    ax.plot(points['20'][0], points['gd'][1], linewidth = 1, color = 'blue')
    ax.plot(points['100'][0], points['momentum'][1], linewidth = 1, color = 'green')
    ax.plot(points['1000'][0], points['nag'][1], linewidth = 1, color = 'black')
